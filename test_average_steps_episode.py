...
if __name__ == '__main__':
    ...
    compare_results(
        ...
        env=environment._grid_shape, num_agents=environment.n_agents, num_prey=environment.n_preys, num_prey2=environment.n_preys2, num_episodes=opt.episodes, percentage_greedy=opt.percentage_greedy
    )